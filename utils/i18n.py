...
_DICT = {
    "es": {
        ...
        "width": "Ancho (px)",
        "height": "Alto (px)",
        "resize_mode_fixed": "Ancho fijo",
        "resize_mode_custom": "Ancho y alto",
        "fixed_w1_lbl": "Ancho escritorio (px)",
        "fixed_w2_lbl": "Ancho móvil (px)",
        "dual_enable": "Generar segunda versión (móvil)",
        "auto_px_suffix": "Sufijo automático _[ancho]px",
        "fixed_note": "* El alto se calcula por imagen (sin distorsión)",
        "name_preview": "Ejemplo:",
        "meta_hdr": "Metadatos",
    ...
    "en": {
        ...
        "width": "Width (px)",
        "height": "Height (px)",
        "resize_mode_fixed": "Fixed width",
        "resize_mode_custom": "Width & height",
        "fixed_w1_lbl": "Desktop width (px)",
        "fixed_w2_lbl": "Mobile width (px)",
        "dual_enable": "Generate second version (mobile)",
        "auto_px_suffix": "Auto suffix _[width]px",
        "fixed_note": "* Height is computed per image (no distortion)",
        "name_preview": "Example:",
        "meta_hdr": "Metadata",
